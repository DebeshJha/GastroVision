...
filename='results_e'+str(max_epochs)+'_'+'b'+str(batch_size)+'_'+'lr'+str(lr)+'_'+'densenet169'   #filename used for saving epoch-wise training details and test results 
...
class train:
    ...
    def train_net(self):
        ...
        best_model=torchvision.models.densenet169(weights=False).to(device)
