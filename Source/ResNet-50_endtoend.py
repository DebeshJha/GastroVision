...
filename='results_e'+str(max_epochs)+'_'+'b'+str(batch_size)+'_'+'lr'+str(lr)+'_'+'resnet50_endtoend'   #filename used for saving epoch-wise training details and test results 
