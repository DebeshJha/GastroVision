...
class train:
    ...
    def train_net(self):
        ...
        model.load_state_dict(torch.load('./resnet50-0676ba61.pth',map_location='cuda'))  # provide a .pth path for already downloaded weights otherwise comment this line out 	        
